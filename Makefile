...
# Generated by qmake (3.0) (Qt 5.0.1) on: Wed Jul 2 18:16:58 2014
# Project:  QuincePAD.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile QuincePAD.pro
#############################################################################
...
CXXFLAGS      = -std=c++11 -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++ -I. -I. -Isrc/Core -Isrc/Support -I/usr/include/qt5 -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: QuincePAD.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile QuincePAD.pro
...
dist: 
	@test -d .tmp/qpad1.0.0 || $(MKDIR) .tmp/qpad1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qpad1.0.0/ && $(COPY_FILE) --parents src/Core/lexer.h src/Core/parser.h src/Support/file.h src/Support/metadata.h .tmp/qpad1.0.0/ && $(COPY_FILE) --parents src/Core/lexer.cpp src/Core/main.cpp src/Core/parser.cpp src/Support/metadata.cpp .tmp/qpad1.0.0/ && (cd `dirname .tmp/qpad1.0.0` && $(TAR) qpad1.0.0.tar qpad1.0.0 && $(COMPRESS) qpad1.0.0.tar) && $(MOVE) `dirname .tmp/qpad1.0.0`/qpad1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qpad1.0.0
...
lexer.o: src/Core/lexer.cpp src/Core/lexer.h \
		src/Support/file.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lexer.o src/Core/lexer.cpp

main.o: src/Core/main.cpp src/Core/parser.h \
		src/Core/lexer.h \
		src/Support/file.h \
		src/Support/metadata.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o src/Core/main.cpp

parser.o: src/Core/parser.cpp src/Core/parser.h \
		src/Core/lexer.h \
		src/Support/file.h \
		src/Support/metadata.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parser.o src/Core/parser.cpp

metadata.o: src/Support/metadata.cpp src/Support/metadata.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o metadata.o src/Support/metadata.cpp
